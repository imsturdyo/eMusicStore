                        ...
                        <div class="row">
                            <div class="col-xs-6 col-sm-6 col-md-6">
                                <address>
                                    ...
                                    <br>
                                        ${order.cart.customer.shippingAddress.doorNumber}
                                    <br>
                                        ${order.cart.customer.shippingAddress.city}, ${order.cart.customer.shippingAddress.country}
                                    <br>
                                        ${order.cart.customer.shippingAddress.postcode}
                                    <br>
                                </address>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-xs-6 col-sm-6 col-md-6">
                                <address>
                                    ...
                                    <br>
                                        ${order.cart.customer.billingAddress.doorNumber}
                                    <br>
                                        ${order.cart.customer.billingAddress.city}, ${order.cart.customer.billingAddress.country}
                                    <br>
                                        ${order.cart.customer.billingAddress.postcode}
                                    <br>
                                </address>
                            </div>
                        </div>
